...
const inputGroupAddonVariants = cva(
  "text-muted-foreground flex h-auto min-h-0 shrink-0 cursor-text select-none items-center justify-center gap-2 py-0 text-sm font-medium group-data-[disabled=true]/input-group:opacity-disabled [&>kbd]:rounded-[calc(var(--radius)-5px)] [&>svg:not([class*='size-'])]:size-4",
  {
    variants: {
      align: {
        "inline-start":
          "order-first h-full self-stretch border-r border-input bg-muted/30 px-3 has-[>button]:-ml-2 has-[>kbd]:-ml-1.5",
        "inline-end":
          "order-last h-full self-stretch border-l border-input bg-muted/30 px-3 has-[>button]:-mr-1.5 has-[>kbd]:-mr-1.5",
        "block-start":
