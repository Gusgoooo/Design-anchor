...
function translateAiPrompt(prompt, componentName) {
  ...
  if (/[一-鿿]/.test(result)) {
    return `Use ${componentName} from @design. Use semantic props for variant and size. Do not hardcode colors or spacing. Colors must use design token classes only.`;
  }
