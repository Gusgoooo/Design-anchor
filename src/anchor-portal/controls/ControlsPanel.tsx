  ...
  if (!session) {
    return (
      <EmptyState
        ...
        hint="Pick a component from the sidebar to see its controls."
      />
    );
  }
  ...
  return (
    <div ref={containerRef} className="relative flex h-full flex-col" tabIndex={-1}>
      ...
      {!hasControls ? (
        <EmptyState
          icon={<Sliders size={16} />}
          title="No editable args"
          hint="This story doesn't expose any controls."
        />
      ) : (
      ...
      <div className="flex items-center justify-between gap-3">
        <div className="flex min-w-0 items-center gap-2 text-[11px] text-muted-foreground">
          ...
          <span className="truncate">
            ...
            pending · preview shows previous values
          </span>
        </div>
