...
export function renderCursorrules(specs, decorativeLibs, activePresetStyle = null) {
  ...
  lines.push("");
  lines.push("If the request contains open/show/check/list/change/edit/configure/查看/看看/打开/调整/修改/配置 plus token/theme/theme editor/component/spec/dashboard/health/preset/docs terms, open Portal. Skip this only when the user explicitly says not to open Portal or asks for code-only file edits.");
  lines.push("");
